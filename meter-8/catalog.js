(function () {
  ...
  function render() {
    ...
    if (!visible.length) {
      ...
      document.querySelector('#empty-copy').textContent = hasProducts ? 'Probeer een andere zoekterm of kies een ander filter.' : 'Meter 8 staat klaar voor de echte productgegevens.';
    }
  }
  ...
  function openProduct(product) {
    ...
    dialogContent.innerHTML = `<div class="dialog-product">
      ...
      ${product.ingredients ? `<section><h3>Ingrediënten</h3><p>${escapeHtml(product.ingredients)}</p></section>` : ''}
