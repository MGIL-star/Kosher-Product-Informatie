(function () {
  ...
  function render() {
    ...
    if (!visible.length) {
      ...
      document.querySelector('#empty-copy').textContent = hasProducts ? 'Probeer een andere zoekterm of kies een ander filter.' : 'Meter 9 staat klaar voor de echte productgegevens.';
    }
  }
  ...
  function openProduct(product) {
    ...
    dialogContent.innerHTML = `<div class="dialog-product">
      ...
      ${product.detailsPending ? '' : `<section><h3>Allergenen</h3><div class="allergen-list">${allergens}</div>${product.allergenNote && product.allergens !== null ? `<p>${escapeHtml(product.allergenNote)}</p>` : ''}</section>`}
